...
{
    public partial class frmCancelacionesTransferenciasGrupal : Form
    {
        ...
        public frmCancelacionesTransferenciasGrupal(int tipoCancelacionesTransferencias, int tipoCancelaciones, int numeroBoletos)
        {
            InitializeComponent();
