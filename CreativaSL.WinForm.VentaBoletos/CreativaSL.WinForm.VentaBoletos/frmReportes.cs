...
namespace CreativaSL.WinForm.VentaBoletos
{
    public partial class frmReportes : Form
    {
        ...
        public frmReportes(int opcion)
        {
            infoTipoReporte = opcion;
            InitializeComponent();
        }
        public frmReportes(int opcion, ReportesBoletosViajeHecotours ViajeAux)
        {
            infoTipoReporte = opcion;
            InitializeComponent();
            ViajeAux_HecoTours = ViajeAux;
        }
        public frmReportes(int opcion, Maletas _maletas)
        {
            infoTipoReporte = opcion;
            maletas = _maletas;
            InitializeComponent();
        ...
        private void btn_VerTodos_Click(object sender, EventArgs e)
        {
            try
            {
                if (verTodo == 0)
                {
                    ...
                    btn_VerTodos.ImageNormal = Properties.Resources.CardBron;
                    verTodo = 1;
                    CargarReporte();
                }
                else
                {
                    ...
                    btn_VerTodos.ImageNormal = Properties.Resources.CardGold;
                    verTodo = 0;
                    CargarReporte();
                }
            }
