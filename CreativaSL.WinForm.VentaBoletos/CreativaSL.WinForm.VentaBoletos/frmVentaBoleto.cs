...
{
    public partial class frmVentaBoleto : Form_Creativa
    {
        ...
        public frmVentaBoleto(VentaBoleto VentaAux, V2Cliente cliente)
        {
            try
            {
        ...
        public frmVentaBoleto(VentaBoleto VentaAux)
        {
            try
            {
