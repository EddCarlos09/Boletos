...
{
    public partial class frmCatSalidasV2 : MaterialForm
    {
        ...
        public frmCatSalidasV2()
        {
            ...
            MaterialListView materialListView = this.dgvRutasInt;
        }

        public frmCatSalidasV2(Viaje viaje)
        {
            InitializeComponent();
            this.EstablecerPropiedadesListRutas();
            this.llenarCombos();
        ...
        private void EstablecerPropiedadesListRutas()
        {
            try
            {
                ...
                this.RecorrerFor(Headertexts, this.dgvRutasInt);
        ...
        private void llenarGridRutasIntermedias(Ruta ruta)
        {
            ...
            try
            {
                ...
                this.dgvRutasInt.Items.Clear();

                // Iterar sobre tus datos y agregarlos al ListView
                foreach (var rutaIntermedia in ruta.rutas_intermedias)
                {
                    ...
                    this.dgvRutasInt.Items.Add(item);
                }
            }
            catch (Exception ex)
            {
