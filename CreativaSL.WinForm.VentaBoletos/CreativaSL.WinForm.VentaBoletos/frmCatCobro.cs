...
{
    public partial class frmCatCobro : Form
    {
        ...
        public frmCatCobro(float total, float pagar, float pendiente, float monederoCliente, string cliente, float nuevoMontoMonedero)
        {
            InitializeComponent();
            Total = total;
            TotalPagar = pagar;
