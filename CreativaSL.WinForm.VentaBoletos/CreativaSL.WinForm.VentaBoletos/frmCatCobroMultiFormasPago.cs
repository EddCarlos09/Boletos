...
{
    public partial class frmCatCobroMultiFormasPago : Form_Creativa
    {
        #region Variables
        ...
        #endregion
        #region Constructor
        public frmCatCobroMultiFormasPago(float total, float pagar, float pendiente, float monederoCliente, string cliente, float nuevoMontoMonedero, V2Cliente clienteV2)
        {
            InitializeComponent();
            Total = total;
            TotalPagar = pagar;
        ...
        public frmCatCobroMultiFormasPago(float total, float pagar, float pendiente, float monederoCliente, string cliente, float nuevoMontoMonedero)
        {
            InitializeComponent();
            Total = total;
            TotalPagar = pagar;
        ...
        public frmCatCobroMultiFormasPago(float total, float pagar, float pendiente, float monederoCliente, string cliente, float nuevoMontoMonedero, int tipo)
        {
            InitializeComponent();
            Total = total;
            TotalPagar = pagar;
        ...
        private void frmCatCobroMultiFormasPago_Load(object sender, EventArgs e)
        {
