...
{
    public partial class frmFechasViajesDetalleV2 : MaterialForm
    {
        public frmFechasViajesDetalleV2(Viaje viaje)
        {
            InitializeComponent();
            loadMaterial(this);
            _infoViajes = viaje;
        ...
        private void frmFechasViajesDetalleV2_Load(object sender, EventArgs e)
        {
            try
            {
                inicalizar();
