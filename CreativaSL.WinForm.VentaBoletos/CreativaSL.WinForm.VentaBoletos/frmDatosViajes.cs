...
{
    public partial class frmDatosViajes : Form_Creativa
    {
        bool _Estadisticos = false;
        public frmDatosViajes(bool Estadisticos)
        {
            try
            {
        ...
        private void btnNuevo_Click(object sender, EventArgs e)
        {
            try
            {
                frmDatosViaje DatosViajes = new frmDatosViaje(new ReportesBoletosViajeHecotours(), dtpFecha.Value);
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.dgvdatosviajes.Rows.Count > 0)
                {
                    ...
                    frmDatosViaje frmDatosViaje = new frmDatosViaje(ViajeAux);
