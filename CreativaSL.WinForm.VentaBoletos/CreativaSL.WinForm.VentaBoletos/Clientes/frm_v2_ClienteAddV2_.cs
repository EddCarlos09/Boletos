...
{
    public partial class frm_v2_ClienteAddV2_ : MaterialForm
    {
        ...
        public frm_v2_ClienteAddV2_(int ID)
        {
            try
            {
                InitializeComponent();
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                frm_v2_AsignarTarjetaV2 Add = new frm_v2_AsignarTarjetaV2(Model.Model.CodigoTarjeta);
                Add.ShowDialog();
                Add.Dispose();
