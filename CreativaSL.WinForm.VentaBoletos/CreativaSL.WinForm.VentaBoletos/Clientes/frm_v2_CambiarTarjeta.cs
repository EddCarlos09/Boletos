...
{
    public partial class frm_v2_CambiarTarjeta : Form_Creativa
    {
        ...
        #endregion
        #region Constructor
        public frm_v2_CambiarTarjeta(V2Cliente datos)
        {
            try
            {
                InitializeComponent();
        ...
        private void MostrarMensajeError(int error)
        {
            try
            {
                ...
                switch (error)
                {
                    case 1: this.txt_mensaje.Text = "Ingrese un número de tarjeta válido.";
                        this.ActiveControl = this.txtNumTarjeta;
                        this.txtNumTarjeta.Focus();
                        break;
                    case 10: this.txt_mensaje.Text = "El número de tarjeta ingresado No está disponible.";
                        this.ActiveControl = this.txtNumTarjeta;
                        this.txtNumTarjeta.Focus();
                       break;
                }
        ...
        private void frmAsignarTarjeta_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
