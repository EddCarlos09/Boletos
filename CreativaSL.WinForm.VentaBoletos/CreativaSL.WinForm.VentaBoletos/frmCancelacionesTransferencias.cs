...
{
    public partial class frmCancelacionesTransferencias : Form_Creativa
    {
        ...
        public frmCancelacionesTransferencias(int tipoCancelacionesTransferencias, int tipoCancelaciones,Boleto DatosBoletos)
        {
            InitializeComponent();
